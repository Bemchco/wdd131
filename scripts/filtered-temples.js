...
const temples = [
  ...
  },
  {
    ...
    area: 38216,
    imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/tucson-arizona/400x250/tucson-arizona-temple-exterior-2291519.jpg"
  },
  {
...
function createTempleCard(filteredTemples) {
    document.querySelector("main").querySelectorAll("figure").forEach(el => el.remove());
